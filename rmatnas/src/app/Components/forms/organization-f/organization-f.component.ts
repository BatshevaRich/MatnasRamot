...
export class OrganizationFComponent implements OnInit {
  ...
  submitForm(f) {
    this.ds.addOrganization(new Organization(this.newOrganization.name, this.newOrganization.contact, this.newOrganization.phone, this.newOrganization.address, this.newOrganization.comments, this.newOrganization.email) );
    f.reset();
  }
}
